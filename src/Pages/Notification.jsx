...
export default function Notification() {
  ...
  return (
    <div className='w-[80%] ml-[20%]'>
      ...
      <div className='w-[50%] flex overflow-y-auto h-[500px] items-center justify-start flex-col mx-4'>
        {data?.data.length > 0 ? (
          data?.data.map((notification, index) => (
            <div
              key={index}
              className={`w-full flex flex-col items-center  bg-white dark:text-white justify-between mt-3 shadow-sm shadow-gray-400 px-4 maxh-[100px]   py-2  dark:bg-zinc-900 rounded-md`}
            >
