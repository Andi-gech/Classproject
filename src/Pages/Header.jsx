...
export default function Header() {
  ...
  return (
    ...
    <div className=' w-[20%] fixed left-0  h-screen rounded-md  bg-white  dark:text-white dark:bg-zinc-900 flex flex-col items-center dark:shadow-gray-900 shadow-gray-300  shadow-lg  z-10'>
    <div className=' h-[90px] w-full px-2 flex flex-row items-center justify-between  shadow-md  dark:shadow-gray-800 shadow-gray-100'>
    <img src={logo} className='w-[50px] rounded-full shadow-md shadow-black h-[50px]'/>
    <div className=' ml-2  h-full flex flex-col items-start justify-center'>
    <p className=' font-bold text-2xl   text-blue-800  font-serif '>Dec Online</p>
  ...
  <AiOutlineHome size={20}   /> <p className='ml-2  '>Dashboard</p>   </Link >
     ...
     <IoIosNotificationsOutline size={20}/> <p className='ml-2'>Notification</p>   </Link  >
    ...
    <TiBook size={20}/>  <p className='ml-2'>Lesson</p>   </Link>  
    ...
    <AiOutlineTrophy size={20}/>  <p  className='ml-2'>Achievment</p> 
      </Link>
      </div>
     
      <div className='flex flex-col'>
      <div className='w-full   ml-[40px] flex items-center '>
      <p className='   text-[16px]  font-medium '>TOP RATED TEACHERS</p>
      </div>
  ...
  <div className='flex   w-[170px]  flex-col justify-center  pl-3 items-start'>
    <p className='m-0 p-0  font-normal'>Mr. Smith</p>
  ...
  <IoMdSettings size={20}   /> <p className='ml-2  '>Settings</p>   </div>
  <div onClick={()=>{signOut()
  navigate('/login')
  ...
  <IoMdOpen size={20}   /> <p className='ml-2  '>LogOut</p>   </div>
