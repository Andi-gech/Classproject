...
const navigate = useNavigate()
  ...
  const handleSignup = async () => {
    ...
    try {
      const result = await axios.post('http://localhost:8080/api/user/create', { fullName:Fullname, email:Email, password ,role:'student',confirmpassword });
...
<div className='w-[90%] relative h-[70px] mt-[5px] '>
        ...
        <div onClick={handleSignup} className='w-[80%] mt-[40px] cursor-pointer hover:bg-zinc-700 rounded-md h-[50px] flex items-center justify-center bg-black'>
