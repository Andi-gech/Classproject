...
export default function Achievement() {
  ...
  return (
    <div className="ml-[18%] w-[82%] h-[100vh] px-4 bg-white dark:bg-slate-950 min-h-[99vh] flex flex-row py-5 overflow-auto">
        {data && data?.data?.map((item) => {
            return (
                <div className="relative mx-3 my-3 w-[450px] border-double p-[30px] h-[280px] rounded-md bg-white shadow-sm shadow-black">
                {/* Trophy icon */}
